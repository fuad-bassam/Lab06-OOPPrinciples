...
namespace ZOO
{
    public class GameHut : Markets
    {


        public GameHut(int placeNum, string placeName, float PlaceSizes, decimal rentBills)
        {
            this.placeNum = placeNum;
            this.placeName = placeName;
            this.placeSize = PlaceSizes;
            this.rentBills = rentBills;
            this.placeType = "GameHut";
        ...
        public  void gameSound()
        {
           ...
           Console.WriteLine( "Oooo game game ");
